...
This starts the Express server which handles all data and AI processing and install all dependencies.
...
Open a new terminal window and run the client application and install all dependencies.
...
`https://lostnfound-phi.vercel.app`
Backend | Core Server Logic (Server)
`https://losthub-backend.vercel.app`